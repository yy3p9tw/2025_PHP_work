...
<body class="warm-bg">
    <div class="container py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
            ...
            <a href="add.php" class="btn btn-primary btn-sm">＋ 新增客戶</a>
        </div>
                ...
                <div class="col">
                    <div class="card h-100 shadow-sm">
                        ...
                        <div class="card-footer bg-white border-0 d-flex gap-2 flex-wrap">
                            <a href="edit.php?id=<?= $c['id'] ?>" class="btn btn-outline-primary btn-sm">編輯</a>
                            <a href="delete.php?id=<?= $c['id'] ?>" class="btn btn-outline-danger btn-sm" onclick="return confirm('確定要刪除嗎？')">刪除</a>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
